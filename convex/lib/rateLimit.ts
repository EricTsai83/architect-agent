...
export const DEEP_ANALYSIS_JOB_LEASE_MS = readPositiveIntEnv(
...
export const rateLimiter = new RateLimiter(components.rateLimiter, {
  ...
  chatRequestsGlobal: {
    ...
    capacity: readPositiveIntEnv(
      ...
      DEFAULT_GLOBAL_CHAT_BURST_CAPACITY,
    ),
    shards: 10,
  },
  daytonaRequestsGlobal: {
...
export function throwOperationAlreadyInProgress(
